# 环境准备<a name="dms-ug-180604012"></a>

创建 Kafka专享版实例前，您需要创建虚拟私有云（Virtual Private Cloud，以下简称VPC），并且已配置好安全组与子网。VPC为Kafka实例提供一个隔离的、用户自主配置和管理的虚拟网络环境，提升资源的安全性，简化用户的网络部署。
