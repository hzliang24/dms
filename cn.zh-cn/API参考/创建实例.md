...
<td class="cellrowborder" valign="top" width="58.58585858585859%" headers="mcps1.2.5.1.4 "><p id="p23466313238"><a name="p23466313238"></a><a name="p23466313238"></a>消息存储空间，单位GB。</p>
<a name="ul821611342209"></a><a name="ul821611342209"></a><ul id="ul821611342209"><li>单机RabbitMQ实例的存储空间的取值范围100G~90000G。</li><li>集群RabbitMQ实例的存储空间的取值范围为100GB*节点数~90000G、200G*节点数~90000G、300G*节点数~90000G。</li><li>Kafka实例规格为100MB时，存储空间取值范围600~90000。</li><li>Kafka实例规格为300MB时，存储空间取值范围1200~90000。</li><li>Kafka实例规格为600MB时，存储空间取值范围2400~90000。</li><li>Kafka实例规格为1200MB，存储空间取值范围4800~90000。</li></ul>
</td>
</tr>
...
<p id="p350512371501"><a name="p350512371501"></a><a name="p350512371501"></a>当engine为kafka时，并且ssl_enable为true时，该参数必选， ssl_enable为false时，该参数无效。</p>
...
<td class="cellrowborder" valign="top" width="58.58585858585859%" headers="mcps1.2.5.1.4 "><p id="p631942102511"><a name="p631942102511"></a><a name="p631942102511"></a>创建节点到指定的AZ ID，该参数不能为空数组或者数组的值为空，详情请参考<a href="查询可用区信息.md">查询可用区信息</a>查询得到。</p>
</td>
</tr>
...
<tr id="row144581138461"><td class="cellrowborder" valign="top" width="17.171717171717173%" headers="mcps1.2.5.1.1 "><p id="p144588354614"><a name="p144588354614"></a><a name="p144588354614"></a>ssl_enable</p>
</td>
...
<td class="cellrowborder" valign="top" width="12.121212121212121%" headers="mcps1.2.5.1.3 "><p id="p7458163154618"><a name="p7458163154618"></a><a name="p7458163154618"></a>否</p>
</td>
...
<td class="cellrowborder" valign="top" width="58.58585858585859%" headers="mcps1.2.5.1.4 "><p id="p155101195211"><a name="p155101195211"></a><a name="p155101195211"></a>存储IO规格。如何选择磁盘类型请参考《<a href="https://support.huaweicloud.com/productdesc-evs/zh-cn_topic_0044524691.html" target="_blank" rel="noopener noreferrer">磁盘类型及性能介绍</a>》。</p>
